...
import { ingestFlowPourEvents, type FlowPourEventInput } from '../../../../lib/flow-store.js';

/**
 * POST /api/os/flow/pour-events
 *
 * Ingests idempotent FLOW pour events and commits depletion into OS ledgers.
 */
export default async function handler(req: Request, res: Response) {
  try {
    const body = req.body as {
      events?: FlowPourEventInput[];
