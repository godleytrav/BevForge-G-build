import { l as listFlowProfiles, g as getLatestFlowProfile } from '../pour-events/GET-LI4duKA3.js';
...
async function handler(req, res) {
  try {
    ...
    if (profileId && String(profileId).trim()) {
      ...
      const match = matches.find((profile2) => profile2.id === String(profileId).trim());
      if (!match) {
